(function (global, factory) {
  ...
  (factory((global.TaroTt = {}),global.taro));
  ...
  function handleLoopRef(component, id, type) {
  ...
  function componentTrigger(component, key, args) {
    ...
    if (key === 'componentDidMount') {
      ...
      if (component['$$refs'] && component['$$refs'].length > 0) {
        var refs = {};
        var refComponents = component['$$refs'].map(function (ref) {
...
//# sourceMappingURL=taro-tt.js.map
