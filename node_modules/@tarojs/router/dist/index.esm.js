...
var createWrappedComponent = function createWrappedComponent(component) {
  ...
  function (_component) {
    ...
    function WrappedComponent(props, context) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(WrappedComponent).call(this, props, context));
...
function (_Taro$Component) {
  ...
  _createClass(Route, [{
    ...
    value: function render() {
      ...
      }, Nerv.createElement(WrappedComponent, {
        ref: this.getRef
      }));
    }
  }]);
...
function (_Taro$Component) {
  ...
  function Router() {
    ...
    _this.collectComponent = function (comp, k) {
      if (_this.currentPages[k]) {
        _this.currentPages[k] = comp;
      } else {
        _this.currentPages.push(comp);
      }
    };
...
var createReLaunch = function createReLaunch(history) {
...
var mountApis = function mountApis(history) {
...
export { createHistory, Router, mountApis };
