...
class BigWheel extends Component {
  state = {
    ...
    lottery: ['一等奖', '二等奖', '谢谢参与', '三等奖', '二等奖', '谢谢参与', '三等奖', '谢谢参与'], //奖品数组
    title: '抽奖页面标题',
  ...
  render() {
    ...
    return <View className="container">
        ...
        {/* 中奖提示弹窗 */}
        {visibleModal && <View className="wheel-modal">
            <View className="wheel-modal-mask"></View>
            <View className="wheel-modal-content">
              <Image className="modal-img" src={isWin ? iconWheelModalSuccess : iconWheelModalFail}></Image>
              <View className="modal-text">
                <Text>{isWin ? winText : failText}</Text>
              </View>
              {isWin ? <View className="modal-btnGroup">
              ...
              'modal-btn-get-long': prizeType == 2
                ...
                </View> : <View className="modal-btnGroup">
                  <View className="modal-btn-continue" onClick={this.closeModal}>
                    <Text>继续努力</Text>
                  </View>
                </View>}
            </View>
        ...
        {/* 中奖记录弹窗 */}
        {visibleHistoryModal && <View className="history-modal">
            <View className="history-modal-mask"></View>
            <View className="history-modal-content">
              <Image onClick={() => this.showHistoryModal(false)} className="iconWheelModalClose" src={iconWheelModalClose}></Image>
